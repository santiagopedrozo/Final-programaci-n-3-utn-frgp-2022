...
(
	Id_Producto_Reseña int NOT NULL,
	DNI_Usuario_Reseña CHAR(10) NOT NULL,
	Contenido_Reseña TEXT,
	Calificacion_Reseña INT CHECK(Calificacion_Reseña > 0 AND Calificacion_Reseña <= 5),
	Fecha_Reseña SMALLDATETIME DEFAULT GETDATE(),
	Estado_Reseña BIT DEFAULT 1

	CONSTRAINT PK_RESEÑAS PRIMARY KEY (Id_Producto_Reseña,DNI_Usuario_Reseña),
	CONSTRAINT FK_RESEÑAS_PRODUCTOS FOREIGN KEY (Id_Producto_Reseña) 
		REFERENCES Productos(Id_Producto),
	CONSTRAINT FK_RESEÑAS_USUARIOS FOREIGN KEY (DNI_Usuario_Reseña) 
...
select 'Periféricos' union -- perifericos de entrada y salida
select 'Placas' union -- placas de video, placas madre, placas de audio
select 'Fuentes alimentación' union -- certificaciones
...
select 1, 'Discos sólidos' union
select 1, 'Discos mecánicos' union
...
select 'Disco Rígido WD 1TB BLUE', 
'Marca: Western Digital, Tipo De Conexión: SATA, Consumo: 30 w, Tipo De Disco: Mecánico, Memoria: Cache 64 mb, Velocidad De Rotación: 7200 rmp, Tasa De Transferencia: 6.0 gb/s, Factor 3.5, Capacidad: 1000 gb.'
,5965, 1, 1, 450, '~/ProductosImagenes/Disco Rígido WD 1TB BLUE.jpg' union

select 'Disco Sólido SSD WD 240GB GREEN', 
'Tipo De Conexión: SATA, Consumo: 5 w, Tipo De Disco: Sólido, Memoria Cache: 0 mb, Velocidad De Rotación: 0 rmp, Tasa De Transferencia: 6.0 gb/s, Vel Lectura Secuencial: 545 mb/s, Vel Escritura Secuencial: 435 mb/s, Vel Lectura Random: 37000 iops, Vel Escritura Random: 68000 iops, Vida Útil: 1000000 horas, Terabytes Written: 80 tb, Factor 2.5, Capacidad: 240 gb.',
4399, 1, 2, 370, '~/ProductosImagenes/Disco Sólido SSD WD 240GB GREEN.jpg' union

select 'Fuente Gigabyte 450W 80 Plus Bronze', 
'Watts Nominal: 450 w, Watts Reales: 432 w, Formato ATX Compatible Con Posición Inferior: Si, Certificación: 80 PLUS Bronze, Modo Híbrido: No, Tipo De Cableado: Cables fijos Ampers En Linea +12V 36 a Fuente Digital: No, Color: Negro, no incluye kit 220v.',
6990, 2, 3, 200, '~/ProductosImagenes/Fuente Gigabyte 450W 80 Plus Bronze.jpg' union

select 'Fuente Thermaltake 500W', 
'Watts Nominal: 500 w, Watts Reales: 420 w, Formato ATX Compatible Con Posición Inferior: Si, Certificacion 80 Plus: No, Modo Híbrido: No, Tipo De Cableado Cables fijos Ampers En Linea +12V 35 a Fuente Digital: No, Color Negro, incluye kit 220v.',
6990, 2, 4, 300, '~/ProductosImagenes/Fuente Thermaltake 500W.jpg' union

select 'Gabinete Slim Performance 5836 Cx', 
'Modelo: SLIM MAX. Tamaño: 29.5 x 9.9 x 36.5 Color: Negro, Bahia Ext: 1 5 1/4, Bahia Int: 2 3 1/2, Soporta Motherboard: Micro ATX/ITX Slot I/O, 4 Material: SECC/SGCC/SPCC, ABS Plastico Grosor chapa: 0.5 mm, USB/AUDIO: 2, USB/AUDIO/MIC, Conector Auxiliar: 4.',
...
'Marca Corsair, Línea Airflow, Modelo; 5000, Incluye fuente de alimentación: No, Tipo de estructura: Mid towe,r Puertos: (1x) USB 3.1, Type C,(2x) USB 3.0,(1x) Audio in/out Bahías: (x2) 3.5in (x4) 2.5in Altura x Ancho x Largo: 520 cm x 245 cm x 520 cm, Es gamer: Sí.',
...
'Marca: Logitech, Línea: Pro Series Modelo G Pro Hero, Color: Negro, Sensor Tipo: Óptico, Tecnología del sensor: Hero 25K, Resolución del sensor: 25600 dpi. Peso y dimensiones: Largo 116.6 mm Ancho 62.15 mm, Altura 38.2 mm, Especificaciones.',
3560, 5, 10, 250, '~/ProductosImagenes/Mouse Logitech Pro Series G Pro.jpg' union

select 'Monitor Acer 20 V206HQL', 
'Tipo De Iluminación: LED, Tipo De Panel: TN, Pantalla Curva; No,  Conexión 3.5 Mm - Entrada No Conector Auriculares: No, Hdmi 1 Dvi 0 Vga 1 Display Port 0 Puertos Usb 2.0 0 Puertos Usb 3.0 0 Puertos Usb 3.1 0 Mini Display Port..',
...
'Tipo: pcie, Chipset: Gpu RTX 2060, Entrada Video: No, Puente Para Sli/croosfirex - Doble Puente: No, Características Especiales: Ray Tracing + DLSS. CONECTIVIDAD: Vga 0 Dv. Digital 0 Hdmi 1 Displayports 3 Usb Type-c.',
...
'Modelo: 5800X. Socket: AM4 Ryzen 4th Gen. Núcleos: 8, Frecuencia: 3800.00 mhz. Proceso De Fabricación: 7 nm. Chipset Gpu: NO Posee Gráficos Integrados, Hilos: 16, Frecuencia Turbo: 4700 mhz, Tdp: 105 w, Incluye Cooler Cpu: No.',
51990, 7, 15, 35, '~/ProductosImagenes/Procesador AMD Ryzen 7 5800X.jpg' union

select 'Procesador Intel Core i3 10100F', 
'Modelo; 10100F Socket 1200 Comet Lake. Núcleos: 4. Frecuencia: 3600.00 mhz. Proceso De Fabricación: 14 nm, Chipset Gpu: NO Posee Gráficos Integrados. Hilos: 8. Frecuencia Turbo: 4300 mhz. Tdp: 65 w, Incluye Cooler Cpu: Si.',
...
INSERT INTO Usuarios(DNI_Usuario, Nombre_Usuario, Apellido_Usuario, Email_Usuario, Contraseña_Usuario,  EsAdmin_Usuario)
...
INSERT INTO Reseñas(Id_Producto_Reseña,DNI_Usuario_Reseña,Contenido_Reseña,Calificacion_Reseña)
...
SELECT 2,'37972884','Gran rendimiento y gran marca, recomendado para tenerlo buenos años' ,4 UNION
SELECT 3,'40762113','una porquería' ,1
go
...
create view ReseñasHabilitadas
as
select [Id_Producto_Reseña], [DNI_Usuario_Reseña], [Contenido_Reseña], [Calificacion_Reseña], [Fecha_Reseña]
from Reseñas
...
ON Productos INSTEAD OF DELETE AS
	BEGIN
		...
		UPDATE Reseñas
		SET Estado_Reseña = 0
		WHERE Id_Producto_Reseña = (Select Id_Producto from deleted)
	END
GO
...
ON [dbo].[Reseñas] INSTEAD OF DELETE AS
	BEGIN
	SET NOCOUNT ON;
	UPDATE Reseñas
	SET Estado_Reseña = 0
	WHERE Id_Producto_Reseña = (SELECT Id_Producto_Reseña from deleted)
		AND DNI_Usuario_Reseña = (SELECT DNI_Usuario_Reseña from deleted)
	END
GO
...
ON Usuarios INSTEAD OF DELETE AS
	BEGIN
		...
		UPDATE Reseñas
		SET Estado_Reseña = 0
		WHERE DNI_Usuario_Reseña = (Select DNI_Usuario from deleted)
...
if exists (Select DNI_Usuario from Usuarios where DNI_Usuario=@DNI AND Estado_Usuario=0)
	...
	SET NOCOUNT ON
	UPDATE Usuarios
		SET Estado_Usuario = 1,Nombre_Usuario = @Nombre,Apellido_Usuario=@APELLIDO, Email_Usuario=@EMAIL, Contraseña_Usuario=@CONTRASEÑA
...
BEGIN
	update Usuarios
	set Nombre_Usuario = @NOMBRE, Apellido_Usuario = @APELLIDO, Email_Usuario = @EMAIL, Contraseña_Usuario = @CONTRASEÑA
	where DNI_Usuario = @DNI
END
GO
...
AS
IF EXISTS(
SELECT [Email_Usuario], [Contraseña_Usuario] 
FROM Usuarios
WHERE [Email_Usuario] = @email AND [Contraseña_Usuario] = @contrasenia
)
RETURN 1
else RETURN 0
GO
